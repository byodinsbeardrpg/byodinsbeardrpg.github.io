...
gen_data['warrior'] = [
  '<b>warrior</b>.<h3>Equipment</h3><li><b>Key item: </b>Linden wood shield</li><li><b>Armour: </b>Chainmail (2 Defence, bulky)</li><li><b>Shield: </b>Linden wood shield (<b>key item</b>, +1 Defence)</li><li><b>Weapon(s): </b>Bearded axe (d8), ash wood spear (d6, 20\')</li><li><b>Other gear: </b>Memento of defeat</li><li><b>Inventory: </b> Remaining free slots, <b>4 out of 10</b></li><h3>Skills</h3> <p><em><strong>Block (reaction)</strong></em>. Raise shield; <strong>Str</strong> save to avoid all <strong>physical damage</strong> (<strong>Fatigue</strong>).</p> <p><strong><em>Disarm</em>.</strong> Hook your opponent’s weapon hand; target needs to make a <strong>Dex</strong> save or be disarmed (<strong>Fatigue</strong>).</p> <p><strong><em>Hack</em>.</strong> Attack your opponent in a frenzy for <strong>double damage</strong> (<strong>Fatigue</strong>).</p>  <li><strong>Dire strike</strong>: Your opponent must make a <strong>Str</strong> save or stagger from the ferocity of the attack, moving back 5’ and losing their next turn.</li>  <p><strong><em>Parry (reaction)</em>.</strong> Deflect an incoming attack and riposte (<strong>Str</strong>):</p>  <li><strong>Success:</strong> Avoid all <strong>physical damage</strong> and retaliate for <strong>damage advantage.</strong></li> <li><strong>Failure:</strong> Retaliatory attack from the target at <strong>damage advantage</strong>.</li>  <p><strong><em>Thrust</em>.</strong> Lunge forward to extend the range of your weapon and strike targets up to <strong>10 feet</strong> away (<strong>Fatigue</strong>).</p><input type="hidden" id="defence" name="defence" value="3">'
]
...
gen_data['scout'] = [
  '<b>scout</b>.<h3>Equipment</h3><li><b>Key item: </b>Hunting knives</li><li><b>Armour: </b>Quilted cloth (1 Defence)</li><li><b>Weapon(s): </b>Hunting knives (key, d6), elm shortbow (bulky, d6, 60\')</li><li><b>Other gear: </b>Fire oil (blast, d8), skeleton key (small)</li><li><b>Inventory: </b>Remaining free slots, <b>5 out of 10</b></li><h3>Skills</h3> <p><em><strong>Backstab</strong></em>. Duck behind your enemy and inflict a critical strike (<strong>Dex</strong>):</p>  <li><strong>Success:</strong> Strike your target for <strong>double damage.</strong></li> <li><strong>Failure:</strong> Retaliatory attack from the target at <strong>damage advantage.</strong></li> <li><strong>Dire strike:</strong> Follow up with an extra attack that bypasses defence.</li>  <p><strong><em>Dash (reaction)</em>.</strong> Deftly dodge to evade an attack (<strong>Dex</strong>, <strong>Fatigue</strong>):</p>  <li><strong>Success:</strong> Avoid <strong>all damage.</strong></li> <li><strong>Failure: Impair</strong> the enemy’s attack, reducing to <strong>d4 damage.</strong></li>  <p><strong><em>Lacerate</em>.</strong> Slice a deep wound in your enemy for an initial <strong>d6 damage;</strong> roll <strong>d4</strong> to determine bleed damage and duration (<strong>Fatigue</strong>).</p> <p><strong><em>Volley</em>.</strong> Fire two arrows without hesitation—roll damage die twice (<strong>Fatigue</strong>).</p>  <li><strong>Dire strike:</strong> Fire another arrow and roll another damage die.</li> <input type="hidden" id="defence" name="defence" value="1">'
]
  
gen_data['seer'] = [
  '<b>seer</b>.<h3>Equipment</h3><li><b>Key item: </b>Yew staff</li><li><b>Armour: </b>Stout linen (0 Defence)</li><li><b>Weapon(s): </b>Yew staff (key, d6)</li><li><b>Magic: </b>Spells ({runestone})</li><li><b>Other gear: </b>Bleached jawbone</li><li><b>Inventory: </b>Remaining free slots, <b>7 out of 10</b></li><h3>Skills</h3> <p><strong><em>Barrier (reaction)</em>.</strong> Cast a barrier spell (Wit, Fatigue):</p>  <li><strong>Success:</strong> Raise a magical shield to negate all damage from the attack.</li> <li><strong>Failure:</strong> Impose <strong>damage disadvantage</strong> on the target’s attack.</li>  <p><strong><em>Clobber</em>.</strong> Smash the enemy’s head with <strong>damage advantage</strong>; target needs to make a <strong>Str</strong> save or be dazed, losing their next turn (<strong>Fatigue</strong>).</p> <p><strong><em>Greystone</em>.</strong> Cast a magical stone as if from a sling for <strong>d4</strong> damage, 30’ range.</p> <p><strong><em>Slow</em> (spell).</strong> Slows nearby enemies (<strong>Fatigue</strong>).</p> <p><strong><em>Seiðr spear</em> (spell).</strong> Propel a spear of pure energy; strike your foe with the spear for <strong>d10 damage</strong>, 60’ range (<strong>Fatigue</strong>).</p><input type="hidden" id="defence" name="defence" value="0">'
]
